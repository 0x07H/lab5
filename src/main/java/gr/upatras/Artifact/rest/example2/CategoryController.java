...
public class CategoryController {
	...
	@ApiOperation(value = "Updates partially a Category", nickname = "patchServiceTestSpecification", notes = "This updates partially a Category entity.", response = Category.class)
